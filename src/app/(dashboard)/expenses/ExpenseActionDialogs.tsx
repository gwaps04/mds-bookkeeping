// src/app/(dashboard)/expenses/ExpenseActionDialogs.tsx
"use client";
...
// ============================================================================
export function ExpenseEditInterceptor({ targetUrl }: { targetUrl: string }) {
      ...
      <DialogContent className="sm:max-w-[400px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-blue-700">
            <ShieldAlert size={18} /> Modify Expense Ledger
          </DialogTitle>
          <DialogDescription>
            You are about to edit a posted financial outflow. This action will be permanently tracked in the Audit Log.
          </DialogDescription>
        </DialogHeader>
...
// ============================================================================
export function ExpenseDeleteDialog({ expenseId, amount, vendorName }: { expenseId: string, amount: number, vendorName: string }) {
  const [open, setOpen] = useState(false);
  const [confirmText, setConfirmText] = useState("");
        ...
        {status === 'success' ? (
          <div className="py-8 flex flex-col items-center justify-center space-y-4 animate-in zoom-in-95 duration-300">
            ...
            <div className="text-center">
              <h3 className="text-xl font-bold text-neutral-900">Expense Voided</h3>
          ...
          <>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-red-600">
                <ShieldAlert size={18} /> Void Expense Record
              </DialogTitle>
              <DialogDescription>
                You are permanently voiding an outflow of <strong>₱{Number(amount).toLocaleString('en-US')}</strong> to <strong>{vendorName || 'General Payee'}</strong>.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 pt-4 border-t border-neutral-100">
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  placeholder="e.g. Duplicate entry, refund received..." 
