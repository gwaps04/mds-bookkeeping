      ...
      <Card className="shadow-sm border-neutral-200 bg-white overflow-hidden print:border-none print:shadow-none print:rounded-none">
        <CardContent className="p-0">
          <div className="bg-neutral-50 border-b border-neutral-200 p-8 text-center print:bg-white print:border-neutral-900 print:border-b-2">
            ...
            <h2 className="text-base font-bold text-neutral-500 mt-1 print:text-neutral-900">PROFIT AND LOSS STATEMENT</h2>
          ...
          <div className="p-8 md:p-12 space-y-8 text-sm">
              ...
              <div className="space-y-3 pl-4">
                {Object.entries(revenueGroups).length === 0 ? (
                  ...
                  Object.entries(revenueGroups).map(([category, amount]) => (
                    <div key={category} className="flex justify-between text-neutral-700 print:text-neutral-900">
                      <span>{category}</span>
            ...
            <div>
              ...
              <div className="space-y-3 pl-4">
                <div className="flex justify-between text-neutral-700 print:text-neutral-900">
            ...
            <div className="mt-8 pt-6 border-t-2 border-neutral-900">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-black text-3xl ${netIncome < 0 ? 'text-rose-600 print:text-neutral-900' : 'text-neutral-900'}`}>
