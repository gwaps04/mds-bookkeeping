            ...
            <table className="w-full text-left text-sm whitespace-nowrap min-w-[700px]">
              ...
              <tbody className="divide-y divide-neutral-200">
                {(!invoices || invoices.length === 0) ? (
                  ...
                  invoices.map((inv) => (
                    <tr key={inv.id} className="hover:bg-neutral-50 group transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-neutral-100 text-neutral-800 border border-neutral-200">
                          {inv.status}
                        </span>
                      </td>
                        ...
                        <div className="flex items-center justify-center gap-2 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          {isOwner && (
                            <form action={async (formData) => {
                              "use server";
                              await deleteOfficialInvoice(formData);
                            }}>
