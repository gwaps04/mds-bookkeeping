        ...
        <div className="space-y-4">
          ...
          <div className="space-y-5 lg:space-y-2">
            {items.map((item, index) => {
              // THE FIX: Check if this row is using a Catalog Item
              ...
              return (
                ...
                >
                  ...
                  {/* 2. Description Input (LOCKED if Catalog Item) */}
                  <div className="space-y-2 col-span-1 sm:col-span-2 lg:col-span-1 relative">
                    <Label className="text-[10px] font-bold text-neutral-500 uppercase tracking-wider lg:hidden">Description</Label>
                    <div className="relative">
                      <Input 
                        placeholder="Enter details..." 
                        className={`h-11 lg:h-10 transition-colors ${isLocked ? "bg-neutral-100 text-neutral-500 cursor-not-allowed border-transparent focus-visible:ring-0 pr-10" : ""}`}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      type="number" 
                      min="1" 
                      className="h-11 lg:h-10 text-center lg:text-left bg-white" 
                      value={item.quantity} 
                  ...
                  {/* 4. Unit Price (LOCKED if Catalog Item) */}
                  <div className="space-y-2 relative">
                    ...
                    <Input 
                      ...
                      step="0.01" 
                      min="0" 
                      className={`h-11 lg:h-10 font-mono transition-colors ${isLocked ? "bg-neutral-100 text-neutral-500 cursor-not-allowed border-transparent focus-visible:ring-0" : ""}`}
