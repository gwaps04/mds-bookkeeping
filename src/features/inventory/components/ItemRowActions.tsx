        ...
        <div className="fixed inset-0 z-50 bg-neutral-900/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-4 border-b border-neutral-100 bg-neutral-50/50">
              ...
              <button onClick={() => setIsEditOpen(false)} className="p-1 text-neutral-400 hover:text-neutral-900 transition-colors"><X size={20}/></button>
            </div>
            ...
            <form action={async (fd) => { await updateItem(fd); setIsEditOpen(false); }} className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input name="unit_of_measure" defaultValue={item.unit_of_measure} required />
                </div>
              </div>
